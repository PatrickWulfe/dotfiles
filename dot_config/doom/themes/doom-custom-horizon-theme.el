;;; doom-custom-horizon-theme.el --- My custom Doom Horizon theme  -*- lexical-binding: t; -*-
...
(defgroup doom-custom-horizon-theme nil
  "Options for the `doom-custom-horizon' theme."
  :group 'doom-themes)

(defcustom doom-horizon-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-custom-horizon-theme
  :type '(choice integer boolean))

(def-doom-theme doom-custom-horizon
